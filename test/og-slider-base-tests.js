...
function runBaseTests() {
  og_slider_1 = document.getElementById('og_slider_1');

  suite('Base Automation Tests for og-slider', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('og-slider fixture is created', function() {
      assert.isTrue(document.getElementById('og_slider_1') !== null);
    });
